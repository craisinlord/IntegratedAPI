...
/**
 * Extra alternatives to vanilla's TerrainAdjustment.
...
public abstract class EnhancedTerrainAdaptation {
    ...
    /**
     * Direction terrain should blend toward the structure from.
     * DOWN is normal terrain support from below. UP is inverted ceiling support from above.
     */
    ...
    public double computeDensityFactor(
        ...
        if (isInKernelRange(kernelX) && isInKernelRange(kernelY) && isInKernelRange(kernelZ)) {
            ...
            // Calculate squared distance from point to the beard base, which determines bearding vs carving.
