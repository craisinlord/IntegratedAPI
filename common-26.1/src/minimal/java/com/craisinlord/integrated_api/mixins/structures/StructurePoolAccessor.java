...
public interface StructurePoolAccessor {
    ...
    @Mutable
    @Accessor("rawTemplates")
    void integratedapi_setRawTemplates(List<Pair<StructurePoolElement, Integer>> elementCounts);
    ...
    @Mutable
    @Accessor("templates")
    void integratedapi_setTemplates(ObjectArrayList<StructurePoolElement> elements);
}
