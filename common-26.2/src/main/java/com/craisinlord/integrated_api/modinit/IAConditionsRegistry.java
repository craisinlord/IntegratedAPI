...
public final class IAConditionsRegistry {
    ...
    public static final ResourceKey<Registry<Supplier<Boolean>>> IA_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(IntegratedAPI.MODID, "json_conditions"));
