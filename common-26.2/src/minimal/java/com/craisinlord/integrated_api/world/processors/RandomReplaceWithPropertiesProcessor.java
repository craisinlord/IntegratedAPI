...
public class RandomReplaceWithPropertiesProcessor implements StructureProcessor {
    ...
    @Override
    public StructureTemplate.StructureBlockInfo processBlock(LevelReader worldReader, BlockPos pos, BlockPos piecePos, BlockPos pos2, StructureTemplate.StructureBlockInfo infoIn2, StructurePlaceSettings settings) {
