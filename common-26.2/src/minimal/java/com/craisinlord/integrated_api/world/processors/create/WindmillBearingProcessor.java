 ...
 */
public class WindmillBearingProcessor implements StructureProcessor {

    public static final MapCodec<WindmillBearingProcessor> CODEC = MapCodec.unit(WindmillBearingProcessor::new);
    ...
    @Override
    public MapCodec<WindmillBearingProcessor> codec() {
        return CODEC;
    }
}
