...
public class MinDistanceFromWorldOriginPlacement extends PlacementModifier {
    public static final MapCodec<MinDistanceFromWorldOriginPlacement> CODEC = ExtraCodecs.NON_NEGATIVE_INT.fieldOf("min_distance_from_world_origin").xmap(MinDistanceFromWorldOriginPlacement::new, placement -> placement.minDistanceFromWorldOrigin);
    private final int minDistanceFromWorldOrigin;

    private MinDistanceFromWorldOriginPlacement(int minDistanceFromWorldOrigin) {
