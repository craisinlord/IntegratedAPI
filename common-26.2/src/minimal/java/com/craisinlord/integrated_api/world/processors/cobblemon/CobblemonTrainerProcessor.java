...
public class CobblemonTrainerProcessor implements StructureProcessor {
    ...
    private static void summonTrainer(MinecraftServer server, ServerLevel serverLevel, TrainerSpawnRequest request) {
        SpawnLocationKey spawnLocationKey = new SpawnLocationKey(serverLevel.dimension().identifier(), request.pos());
    ...
    @Override
    public MapCodec<CobblemonTrainerProcessor> codec() {
        return CODEC;
    }
