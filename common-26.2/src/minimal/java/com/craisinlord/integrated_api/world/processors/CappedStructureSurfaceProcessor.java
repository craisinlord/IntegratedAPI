...
public class CappedStructureSurfaceProcessor implements StructureProcessor {
    ...
    private static final Pair<StructureTemplate.StructureBlockInfo, Integer> DEFAULT_AIR_BLOCK =
            Pair.of(new StructureTemplate.StructureBlockInfo(BlockPos.ZERO, Blocks.AIR.defaultBlockState(), null), 0);
    private static final Pair<StructureTemplate.StructureBlockInfo, Integer> DEFAULT_SOLID_BLOCK =
            Pair.of(new StructureTemplate.StructureBlockInfo(BlockPos.ZERO, Blocks.STONE.defaultBlockState(), null), 0);
    ...
    @Override
    public MapCodec<CappedStructureSurfaceProcessor> codec() {
        return CODEC;
    }
}
