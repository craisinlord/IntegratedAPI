...
public final class IAPredicates {
    public static final ResourcefulRegistry<RuleTestType<?>> RULE_TEST = ResourcefulRegistries.create(BuiltInRegistries.RULE_TEST, IntegratedAPI.MODID);
    public static final ResourcefulRegistry<PosRuleTestType<?>> POS_RULE_TEST = ResourcefulRegistries.create(BuiltInRegistries.POS_RULE_TEST, IntegratedAPI.MODID);
