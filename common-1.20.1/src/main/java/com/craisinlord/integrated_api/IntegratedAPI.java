...
public class IntegratedAPI {
    ...
    public static void registerDatapackListener(final RegisterReloadListenerEvent event) {
        event.register(new ResourceLocation(IntegratedAPI.MODID, "integrated_structure_spawners"), MobSpawnerManager.MOB_SPAWNER_MANAGER);
        event.register(new ResourceLocation(IntegratedAPI.MODID, "integrated_structure_map_trades"), StructureMapManager.STRUCTURE_MAP_MANAGER);
        event.register(new ResourceLocation(IntegratedAPI.MODID, "integrated_pieces_spawn_counts"), StructurePieceCountsManager.STRUCTURE_PIECE_COUNTS_MANAGER);
        event.register(new ResourceLocation(IntegratedAPI.MODID, "integrated_workstations"), WorkstationManager.WORKSTATION_MANAGER);
    }
}
