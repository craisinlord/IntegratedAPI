...
public class BiomeFacingStructure extends JigsawStructure {
    ...
    public static final Codec<BiomeFacingStructure> CODEC = RecordCodecBuilder.create(instance -> instance.group(
...
//        BlockPos biomePos = nearestBiomeBlockPos(blockpos, context);
//        BlockPos posDif;
//
//
//        IntegratedAPI.LOGGER.info("CRAISIN POS IS: " + blockpos);
//        IntegratedAPI.LOGGER.info("CRAISIN OCEAN BIOME DETECTED: " + biomePos);
//        posDif = new BlockPos(blockpos.getX()-biomePos.getX(), blockpos.getY(), blockpos.getZ()-biomePos.getZ());
//        IntegratedAPI.LOGGER.info("CRAISIN POS DIF DETECTED: " + posDif);
//
//        if (Math.abs(posDif.getX()) > Math.abs(posDif.getZ())) {
//            if (posDif.getX() > 0) {
//                rotationString = "CLOCKWISE_90";
//            } else {
//                rotationString = "COUNTERCLOCKWISE_90";
//            }
//        } else {
//            if (posDif.getZ() > 0) {
//                rotationString = "CLOCKWISE_180";
//            } else {
//                rotationString = "NONE";
//            }
//        }
...
//        IntegratedAPI.LOGGER.info("CRAISIN ROTATION WAS: " + rotationString);
