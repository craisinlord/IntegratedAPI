...
public class StructureNbtUpdater implements DataProvider {
    ...
    public StructureNbtUpdater(String basePath, String modid, net.neoforged.neoforge.common.data.ExistingFileHelper helper, PackOutput output) {
        this.basePath = basePath;
        this.modid = modid;
        this.output = output;

        try {
            Field serverData = net.neoforged.neoforge.common.data.ExistingFileHelper.class.getDeclaredField("serverData");
