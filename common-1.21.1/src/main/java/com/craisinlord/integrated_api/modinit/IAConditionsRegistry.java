...
public final class IAConditionsRegistry {
    ...
    public static final ResourceKey<Registry<Supplier<Boolean>>> IA_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(IntegratedAPI.MODID, "json_conditions"));
    ...
    public static final RegistryEntry<Supplier<Boolean>> ALWAYS_FALSE = IA_JSON_CONDITIONS_REGISTRY.register("always_false", () -> () -> false);
}
