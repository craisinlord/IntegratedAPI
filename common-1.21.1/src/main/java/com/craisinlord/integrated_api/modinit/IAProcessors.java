...
import com.craisinlord.integrated_api.world.processors.*;
import com.craisinlord.integrated_api.world.processors.cobblemon.CobblemonTrainerProcessor;
import com.craisinlord.integrated_api.world.processors.create.*;
import net.minecraft.core.registries.BuiltInRegistries;
import net.minecraft.world.level.levelgen.structure.templatesystem.StructureProcessorType;

public final class IAProcessors {
    public static final ResourcefulRegistry<StructureProcessorType<?>> STRUCTURE_PROCESSOR = ResourcefulRegistries.create(BuiltInRegistries.STRUCTURE_PROCESSOR, IntegratedAPI.MODID);
    ...
    public static final RegistryEntry<StructureProcessorType<TrialSpawnerProcessor>> TRIAL_SPAWNER_PROCESSOR = STRUCTURE_PROCESSOR.register("trial_spawner_processor", () -> () -> TrialSpawnerProcessor.CODEC);
    ...
    public static final RegistryEntry<StructureProcessorType<CobblemonTrainerProcessor>> COBBLEMON_TRAINER_PROCESSOR = STRUCTURE_PROCESSOR.register("cobblemon_trainer_processor", () -> () -> CobblemonTrainerProcessor.CODEC);
    ...
    public static final RegistryEntry<StructureProcessorType<FluidTankProcessor>> FLUID_TANK_PROCESSOR = STRUCTURE_PROCESSOR.register("fluid_tank_processor", () -> () -> FluidTankProcessor.CODEC);
    ...
    public static final RegistryEntry<StructureProcessorType<ClockworkBearingProcessor>> CLOCKWORK_BEARING_PROCESSOR = STRUCTURE_PROCESSOR.register("clockwork_bearing_processor", () -> () -> ClockworkBearingProcessor.CODEC);
    public static final RegistryEntry<StructureProcessorType<ElevatorPulleyProcessor>> ELEVATOR_PULLEY_PROCESSOR = STRUCTURE_PROCESSOR.register("elevator_pulley_processor", () -> () -> ElevatorPulleyProcessor.CODEC);
