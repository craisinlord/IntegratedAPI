 ...
 * Note that "integrated_api:all" is an acceptable entry for matching any piece.
 */
public class PieceInRangeCondition extends StructureCondition {
    ...
    public boolean passes(StructureContext ctx) {
        ...
        if (templateManager == null) IntegratedAPI.LOGGER.error("Missing required field 'structureTemplateManager' for piece_in_range condition!");
        if (pieces == null) IntegratedAPI.LOGGER.error("Missing required field 'pieces' for piece_in_range condition!");
