...
public class PieceInHorizontalDirectionCondition extends StructureCondition {
    private static final ResourceLocation ALL = ResourceLocation.fromNamespaceAndPath(IntegratedAPI.MODID, "all");
    ...
    public boolean passes(StructureContext ctx) {
        ...
        if (templateManager == null) IntegratedAPI.LOGGER.error("Missing required field 'structureTemplateManager' for piece_in_horizontal_direction condition!");
        if (pieces == null) IntegratedAPI.LOGGER.error("Missing required field 'pieces' for piece_in_horizontal_direction condition!");
        if (rotation == null) IntegratedAPI.LOGGER.error("Missing required field 'rotation' for piece_in_horizontal_direction condition!");
        if (pieceEntry == null) IntegratedAPI.LOGGER.error("Missing required field 'pieceEntry' for piece_in_horizontal_direction condition!");
        ...
        for (PieceEntry otherPieceEntry : pieces) {
            ...
            if (otherPiece.getElement() instanceof SinglePoolElement || otherPiece.getElement() instanceof IASinglePoolElement) {
                ...
                StructureTemplate otherStructureTemplate = otherPiece.getElement() instanceof SinglePoolElement
                        ...
                        : ((IASinglePoolElement) otherPiece.getElement()).getTemplate(templateManager);
