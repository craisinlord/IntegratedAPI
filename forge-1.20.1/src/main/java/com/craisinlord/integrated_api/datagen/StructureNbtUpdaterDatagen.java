...
@Mod.EventBusSubscriber(modid = IntegratedAPI.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class StructureNbtUpdaterDatagen {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        if (event.includeServer()) {
            gen.addProvider(true, new StructureNbtUpdater("structures", IntegratedAPI.MODID, exHelper, output));
        }
    }
}
